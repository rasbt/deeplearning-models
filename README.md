...
| Title                      | Dataset | Description | Notebooks                                                    |
| -------------------------- | ------- | ----------- | ------------------------------------------------------------ |
| AutoAugment for Image Data | CIFAR-10     | Trains a ResNet-18 using AutoAugment         | [![PyTorch Lightning](https://img.shields.io/badge/PyTorch-Lightning-blueviolet)](./pytorch-lightning_ipynb/data-augmentation/autoaugment) |
